...
* Sped up merging by body advanced optimisation.
...
* Fixed issue [#654](https://github.com/jakubpawlowicz/clean-css/issues/654) - disables length optimisations.
...
* Adds unit compatibility switches to disable length optimisations.
...
* Unifies wrappers for simple & advanced optimisations.
...
* Fixed issue [#625](https://github.com/jakubpawlowicz/clean-css/issues/625) - adds length unit optimisations.
* Fixed issue [#632](https://github.com/jakubpawlowicz/clean-css/issues/632) - adds disabling remote `import`s.
* Fixed issue [#635](https://github.com/jakubpawlowicz/clean-css/issues/635) - adds safer `0%` optimisations.
* Fixed issue [#644](https://github.com/jakubpawlowicz/clean-css/issues/644) - adds time unit optimisations.
...
* Fixes non-adjacent optimisations for source maps.
...
* Fixed issue [#630](https://github.com/jakubpawlowicz/clean-css/issues/630) - vendor prefixed flex optimisations.
...
* Fixed issue [#517](https://github.com/jakubpawlowicz/clean-css/issues/517) - turning off color optimisations.
...
* Fixed issue [#521](https://github.com/jakubpawlowicz/clean-css/issues/521) - unit optimisations inside `calc()`.
...
* Adds restructuring optimisations to reorganize selectors, which vastly improves minification.
...
* Fixed issue [#184](https://github.com/jakubpawlowicz/clean-css/issues/184) - uses `!important` for optimisation opportunities.
...
* Fixed issue [#199](https://github.com/jakubpawlowicz/clean-css/issues/199) - keep line breaks with no advanced optimisations.
...
* Adds `--skip-advanced`/`noAdvanced` switch to disable advanced optimisations.
...
* Speed optimisations (~10% despite many new features).
