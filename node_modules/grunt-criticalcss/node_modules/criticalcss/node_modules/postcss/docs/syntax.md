...
The main rule of optimisation is that there is no performance without a
...
Second optimisation is using character codes instead of strings.
...
Third optimisation is “fast jumps”. If you find open quotes, you can find
...
hardcore optimisation there. You can extend the default [PostCSS parser].
